...
export function EmojiPicker({
	...
	return (
		<div className="bg-background flex h-[350px] w-[316px] flex-col rounded shadow-[rgb(15_15_15_/_5%)_0_0_0_1px,_rgb(15_15_15_/_10%)_0_3px_6px,_rgb(15_15_15_/_20%)_0_9px_24px]">
