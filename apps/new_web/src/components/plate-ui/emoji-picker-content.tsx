...
export function EmojiPickerContent({
		...
		return emojiLibrary
			...
			.map(({ id: categoryId }) => {
				...
				return (
					...
					>
						<div className="bg-background/90 sticky -top-px z-[1] p-1 backdrop-blur-sm">
	...
	return (
		<div
			className=":hover:[&::-webkit-scrollbar-thumb]:bg-[#f3f4f6] h-full min-h-[50%] overflow-y-auto overflow-x-hidden px-3 [&::-webkit-scrollbar-button]:hidden [&::-webkit-scrollbar-button]:size-0 [&::-webkit-scrollbar-thumb]:min-h-[65px] [&::-webkit-scrollbar-thumb]:rounded-2xl [&::-webkit-scrollbar-thumb]:border-4 [&::-webkit-scrollbar-thumb]:border-white [&::-webkit-scrollbar-track]:border-0 [&::-webkit-scrollbar]:w-4"
			data-id="scroll"
