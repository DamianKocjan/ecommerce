...
const toolbarButtonVariants = cva(
	"inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg:not([data-icon])]:size-5",
	{
		defaultVariants: {
			size: "sm",
			variant: "default",
					...
					>
						{isDropdown ? (
							<>
								...
								<div>
									<CaretDown className="ml-0.5 size-4" data-icon />
								</div>
							</>
						) : (
							children
