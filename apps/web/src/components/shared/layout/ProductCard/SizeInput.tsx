		...
		return (
			<label className="cursor-pointer">
				...
				<Flex
					items="center"
					justify="center"
					className="relative h-10 w-10 text-black before:absolute before:top-0.5 before:left-0.5 before:z-[-1] before:h-full before:w-full peer-checked:bg-black peer-checked:text-white peer-checked:before:bg-teal-400"
				>
					{size}
				</Flex>
			</label>
