...
export const ProductCardShimmer: React.FC = () => {
	return (
		<Flex direction="col" className="animate-pulse space-y-2">
			<div className="relative h-64 w-full bg-black/25 before:absolute before:top-0.5 before:left-0.5 before:z-[-1] before:h-full before:w-full before:bg-teal-400/10 md:before:top-1 md:before:left-1" />
